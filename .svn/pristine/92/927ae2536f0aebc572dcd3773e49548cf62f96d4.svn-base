...
enum login_commands { BadLogin, GoodLogin, TryLogin, DoLogin, ServerFull, UnknownLoginCommand };
...
enum lobby_commands { LobbyChat, LobbyJoinServer,  FindGame, CreateGame, ShowPlayerModel, CreateCharactor, SwitchCharactor,
  CharactorList, JoinChatroom, CreateChatroom, ListChatroom,  LeaveChatroom, KickPlayer, MutePlayer, SetOps };
#include "OLC/OLC_Enum.hpp"
enum command_types { NetCommand, LoginCommand, UnKnownCommandType, LocalEvent, InventoryCommand, ShopCommands, Combat, Skill, Register, OLC, LobbyCommands };
...
struct inet_player : public Player {
	...
	static std::vector<boost::shared_ptr<inet_player> > Players;
	bool is_client;
	bool logged_in;
	bool lobby_logged_in;
	bool deleteMe;
